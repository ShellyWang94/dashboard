This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app).  The main tools is `react`, `react-router`, `redux`, `react-redux`, using css module.  
